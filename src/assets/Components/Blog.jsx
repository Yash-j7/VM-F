...
const blogs = [
    ...
    },
    {
        ...
        description:
            'How to keep customers buying your products?',
    },
];
    ...
    return (
        ...
        <div className="container mx-auto px-4">
          ...
          <h1 className="text-5xl font-bold text-center mb-8">
            Guide From Our <span className="text-red-500 underline decoration-red-500">Blog</span>
          </h1>
          {/* Subtext */}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            {blogs.map((blog) => (
              <div key={blog.id} className="rounded-xl overflow-hidden shadow-lg transition-transform transform hover:scale-105 h-full flex flex-col">
                {/* Blog Image and Tags */}
                <div className="relative h-56">
                  <img src={blog.img} alt={blog.title} className="w-full h-full " />
                  {/* Category Tag */}
                  ...
                  <div className="absolute top-2 right-2 bg-red-600 text-white px-3 py-1 rounded-sm text-center">
                    <span className="block font-bold text-xl leading-tight">16</span>
                ...
                <div className="flex flex-col justify-between bg-gradient-to-b from-red-500 to-yellow-500 p-6 text-white flex-grow">
                  ...
                  <p className="text-2xl px-3 mb-4 leading-normal">{blog.description}</p>
                  <a
                    href={blog.link}
